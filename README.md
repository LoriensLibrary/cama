...
- **AI safety:** start with the [AI Safety Relevance](#ai-safety-relevance) section + `cama/eval/safety_benchmarks.py`. **Internal-consistency** safety benchmark: 27 sub-tests across provenance discrimination, correction propagation, false-memory detection, adversarial insertion resistance, and drift monitoring. Latest run on the live 53,000-row **single-participant** corpus: **27/27** (this is an internal-consistency check, not external validation. See scope note in the [AI Safety Relevance](#ai-safety-relevance) section). An intermediate 2026-05-17 run came back 26/27; the failure was definition drift in sub-test 1e (the benchmark itself), not a data violation. Investigation logged and fix landed via [issue #7](https://github.com/LoriensLibrary/cama/issues/7). See `benchmark_results.json` for the raw output.
...
- Reinhold, A. (2026). *Persistent Memory as Mission-Critical Infrastructure for Long-Duration Spaceflight.* DOI: [10.5281/zenodo.19257808](https://doi.org/10.5281/zenodo.19257808) · [PDF](papers/06_spaceflight.pdf)
- Reinhold, A. (2026). *Memory-Aware AI Systems for Permanent Lunar and Martian Habitation.* DOI: [10.5281/zenodo.19260573](https://doi.org/10.5281/zenodo.19260573) · [PDF](papers/07_lunar_martian_habitation.pdf)
