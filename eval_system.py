...
# 5. _parse_t check
print("\n[5] _parse_t FIX")
with open(r'C:\Users\Angela\Desktop\cama\cama_mcp.py', 'r', encoding='utf-8') as f:
    mcp_content = f.read()
...
with open(r'C:\Users\Angela\Desktop\cama\cama_sleep.py', 'r', encoding='utf-8') as f:
...
# 13. Git status
print("\n[13] GIT STATUS")
result = subprocess.run(['git', '-C', r'C:\Users\Angela\Desktop\cama', 'status', '--short'],
                       capture_output=True, text=True, timeout=10)
