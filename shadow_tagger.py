...
# ============================================================
KNOWN_TAGS = [
    # Memory 6070 — "Mike is gone... I'm the home wrecker... I just want security"
    # Contains Mike's projection absorbed + Angela's internalized shame
    (6070, "projection_absorbed", "Mike"),
    ...
    # Memory 52641 — Tackett boundary
    (52641, "projection_absorbed", "Tackett"),
    ...
    # Memory 6294 — "Zeke is here... that's the ground"
    # Clean grounding
    (6294, "clean", None),
    ...
    (52555, "projection_absorbed", "Tackett"),
